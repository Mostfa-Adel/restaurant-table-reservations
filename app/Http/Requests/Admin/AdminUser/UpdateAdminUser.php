...
class UpdateAdminUser extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'employee_number' => ['sometimes','string', Rule::unique('admin_users', 'employee_number')->ignore($this->adminUser->getKey(), $this->adminUser->getKeyName())],
            'password' => ['nullable','sometimes', 'confirmed', 'min:7', 'regex:/^.*(?=.{3,})(?=.*[a-zA-Z])(?=.*[0-9]).*$/', 'string'],
