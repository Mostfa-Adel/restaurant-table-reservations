...
class FillPermissionsForRestaurantTableReservation extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRestaurantTableReservation constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.restaurant-table-reservation',
            'admin.restaurant-table-reservation.index',
            'admin.restaurant-table-reservation.create',
            'admin.restaurant-table-reservation.show',
            'admin.restaurant-table-reservation.edit',
            'admin.restaurant-table-reservation.delete',
            'admin.restaurant-table-reservation.bulk-delete',
        ]);
