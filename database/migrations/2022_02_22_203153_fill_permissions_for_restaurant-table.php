...
class FillPermissionsForRestaurantTable extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRestaurantTable constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.restaurant-table.index',
            'admin.restaurant-table.create',
            'admin.restaurant-table.show',
            'admin.restaurant-table.edit',
            'admin.restaurant-table.delete',
            'admin.restaurant-table.bulk-delete',
        ]);
