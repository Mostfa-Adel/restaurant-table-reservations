...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('employee_number'), 'has-success': fields.employee_number && fields.employee_number.valid }">
    <label for="employee_number" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-3'">{{ trans('admin.admin-user.columns.employee_number') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
        <input type="text" v-model="form.employee_number" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('employee_number'), 'form-control-success': fields.employee_number && fields.employee_number.valid}" id="employee_number" name="employee_number" placeholder="{{ trans('admin.admin-user.columns.employee_number') }}">
